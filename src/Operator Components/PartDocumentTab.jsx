...
// ─── Source of truth: ONLY the status field from the API response ─────────────

// localStorage is NOT used for activation state — it caused false positives

// across jobs on the same machine. selectedJob.status === 'IN-PROGRESS' is
