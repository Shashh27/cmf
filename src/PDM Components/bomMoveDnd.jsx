...
/**
 * Highlight ONLY the product/assembly row currently under the pointer.
 */
...
/**
 * Drop zone for product / assembly header.
 * Banner renders BELOW the row so the assembly name stays readable
 * even when the drag ghost is over the row.
 */
