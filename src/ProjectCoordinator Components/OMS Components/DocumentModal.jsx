...
import { FileTextOutlined, DownloadOutlined, DeleteOutlined, UploadOutlined, ExclamationCircleOutlined } from "@ant-design/icons";
                ...
                <div style={{ position: 'relative', width: '100%', height: '75vh' }}>
                  ...
                  {viewerError && (
                    <div className="flex flex-col items-center justify-center h-full bg-gray-50 p-8 text-center">
                      ...
                      <p className="text-gray-500 mb-4">Please close and try again</p>
                    </div>
                  )}
                  {pdfBlobUrl && (
                    <iframe
