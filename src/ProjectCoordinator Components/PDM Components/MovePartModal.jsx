...
const LocationCard = ({ tone, title, children }) => {
  ...
  return (
    <div
      style={{
        border: `1px solid ${isUpcoming ? "#2E8B57" : "#D6D3C4"}`,
        background: isUpcoming ? "#ECF8F0" : "#FDF5E6",
        padding: "10px 12px",
      }}
    >
      <div
        style={{
          ...
          color: isUpcoming ? "#1B5E3A" : "#5D4037",
          marginBottom: 6,
        }}
      >
        {title}
      ...
      <div
        style={{
          fontSize: 14,
          fontWeight: 600,
          color: isUpcoming ? "#1B5E3A" : "#2F2F2F",
          lineHeight: 1.35,
        }}
      >
        {children}
    ...
    >
      {part && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ textAlign: "center", color: "#2E8B57", lineHeight: 1 }}>
            <ArrowDownOutlined />
          </div>
