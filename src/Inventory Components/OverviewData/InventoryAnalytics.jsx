...
const InventoryAnalytics = () => {
  ...
  const fetchAnalyticsData = async (year) => {
    ...
    try {
      ...
      const requestsResponse = await fetch('http://172.18.7.89:8000/api/v1/inventory-requests/');
      const requestsData = await requestsResponse.json();
      
      // Fetch return requests
      const returnsResponse = await fetch('http://172.18.7.89:8000/api/v1/inventory-return-requests/');
