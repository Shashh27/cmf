...
from DB.models import Machine as MachineModel, WorkCenter as WorkCenterModel
from DB.schemas import Machine, MachineCreate, MachineUpdate, MachineWithWorkCenter
