...
def get_part_operation_details(
    ...
    Data source: PlannedScheduleItem rows generated by /generate-schedule.
    If schedule_history_id is not provided, uses the latest schedule history.
    """
    try:
        ...
        if schedule_history_id is None:
            latest = (
                db.query(ScheduleHistory)
                .order_by(ScheduleHistory.generated_at.desc())
                .first()
